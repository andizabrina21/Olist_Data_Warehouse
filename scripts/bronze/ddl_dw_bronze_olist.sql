...
IF OBJECT_ID('bronze.lob_geolocation', 'U') IS NOT NULL
	DROP TABLE bronze.lob_geolocation;
CREATE TABLE bronze.lob_geolocation(
...
IF OBJECT_ID('bronze.lob_sellers', 'U') IS NOT NULL
	DROP TABLE bronze.lob_sellers;
CREATE TABLE bronze.lob_sellers(
    seller_id NVARCHAR(50),
...
IF OBJECT_ID('bronze.lob_category_name_translation', 'U') IS NOT NULL
	DROP TABLE bronze.lob_category_name_translation;

CREATE TABLE bronze.lob_category_name_translation(
    product_category_name NVARCHAR(50),
