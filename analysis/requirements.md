...
## Introduction
This user stroy outlines the spesification for building two dashboards using tableau to help stakeholders, including sales managers 
and executives to analyze sales performance and customers.

## Sales Dashboard | Reqirements
### Dashboard Purpose
The purpose of sales dashboard is to present an overview of the sales metrics and trend in order to analyze
year-over-year sales performance and understand sales trends.
...
### Data Filters
Allow users to filter data by product information like category and by location information like region, state and city.
